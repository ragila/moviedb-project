...
import requestAccount from '../../services/apiAccount';
...
const MovieDetails = ({ navigation, route }) => {
  ...
  const requestMoviesInfo = async () => {
    try {
      ...
      const Testdata = await requestAccount(`watchlist/movies`, {
        include_image_language: 'en,null',
        append_to_response: 'credits,videos,images'
      });
      console.log(Testdata, 'testt')
    ...
    navigation.setOptions({
      headerRight: () => (
        ...
        >
          ...
          <Icon name="share-2" size={23} color={darkBlue} /> 
        </TouchableOpacity>
      )
    });
  }, [navigation]);
          ...
          {isLoading ? (
            ...
            <ScrollView>
              <PosterRow
                ...
                onPress={handleImage}
              />
              <TouchableOpacity style={{marginLeft: 20, top: 15}}>
